...
import { Search, ChevronDown, Calendar, Clock, User, UserPlus, Search as SearchIcon } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <div className="flex items-center gap-4 sm:gap-6 flex-shrink-0 ml-4">
            ...
            <button 
              ...
              className="flex items-center gap-1.5 text-[10px] font-black uppercase tracking-widest bg-sky-500 hover:bg-sky-600 px-4 py-1.5 rounded-lg transition-all shadow-lg shadow-sky-500/20 active:scale-95"
            >
          ...
          <div className="flex flex-col lg:flex-row items-center gap-6">
            ...
            {isMarketplace && (
              <div className="flex-grow w-full bg-[#F5F8FA] rounded-[24px] border border-[#E1E8ED] p-1.5 flex flex-col md:flex-row items-stretch gap-1 shadow-[0_4px_20px_-8px_rgba(0,174,239,0.15)] focus-within:border-[#00AEEF]/30 transition-all">
                ...
                <div className="flex-1 min-w-0 border-l border-slate-200 px-4 py-2.5 hover:bg-white transition-all group rounded-2xl relative cursor-pointer">
                ...
                <div 
                  ref={shiftRef}
                  className="w-36 border-l border-slate-200 px-4 py-2.5 hover:bg-white transition-all group cursor-pointer relative rounded-2xl"
